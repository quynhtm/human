                            ...
                            <tr>
                                ...
                                <td class="text-center middle">
                                    @if($is_root== 1 || $personContracts_full== 1 || $personContracts_create == 1)
                                        <li><a href="{{URL::route('hr.departmentEdit',array('id' => FunctionLib::inputId($item['contracts_id'])))}}" title="Sửa"><i class="fa fa-edit fa-2x"></i></a></li>
                                    @endif
                                    @if($is_root== 1 || $personContracts_full== 1 || $personContracts_delete == 1)
                                        <li><a class="deleteItem" title="Xóa" onclick="HR.deleteItem('{{FunctionLib::inputId($item['contracts_id'])}}', WEB_ROOT + '/manager/department/deleteDepartment')"><i class="fa fa-trash fa-2x"></i></a></li>
                                    @endif
                                </td>
                            </tr>
                        @endforeach
