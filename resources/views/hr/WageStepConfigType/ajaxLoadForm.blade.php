    ...
    <div class="panel-heading paddingTop1 paddingBottom1">
        <h4>
            @if(isset($data['wage_step_config_id']) && $data['wage_step_config_id'] > 0)
                <i class="fa fa-edit icChage" aria-hidden="true"></i> <span class="frmHead">Sửa thang bảng lương</span>
            @else
                <i class="fa fa-plus-square icChage" aria-hidden="true"></i> <span class="frmHead">Thêm mới thang bảng lương</span>
            @endif
        </h4>
    </div>
