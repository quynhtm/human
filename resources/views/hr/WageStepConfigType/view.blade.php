        ...
        <div class="page-content">
            <div class="row">
                                ...
                                <table class="table table-bordered bg-head-table">
                                    ...
                                    @foreach($data as $key => $item)
                                        <tr>
                                            ...
                                            <td class="text-center">{{isset($arrStatus[$item->wage_step_config_type]) ? $arrStatus[$item->wage_step_config_type] : 'Chưa xác định'}}</td>
                ...
                <div class="col-md-4 panel-content loadForm">
                    <div class="panel panel-primary">
                        <div class="panel-heading paddingTop1 paddingBottom1">
                            <h4><i class="fa fa-plus-square" aria-hidden="true"></i> Thêm mới thang bảng lương</h4>
                        </div>
