    ...
    <div class="main-content-inner">
        <div class="breadcrumbs breadcrumbs-fixed" id="breadcrumbs">
            <ul class="breadcrumb">
                ...
                <li class="active">Chuyển phòng ban/ bộ phận</li>
            </ul><!-- /.breadcrumb -->
        </div>
                ...
                <div class="col-xs-12">
                    ...
                    <!--Block 1--->
                        ...
                        <div class="form-group">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label for="name" class="control-label">Chuyển phòng ban/ bộ phận</label>
                                    <select name="quit_job_depart_id" id="quit_job_depart_id" class="form-control input-sm input-required">
                                        {!! $optionDepart !!}
                                    </select>
                                </div>
                            </div>
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <label for="name" class="control-label">Lý do thay đổi</label>
