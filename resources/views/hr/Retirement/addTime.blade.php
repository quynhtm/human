    ...
    <div class="main-content-inner">
        <div class="breadcrumbs breadcrumbs-fixed" id="breadcrumbs">
            <ul class="breadcrumb">
                ...
                <li class="active">Kéo dài thời gian nghỉ hưu</li>
            </ul><!-- /.breadcrumb -->
        </div>
                ...
                <div class="col-xs-12">
                    ...
                    <!--Block 1--->
                        ...
                        <div class="form-group">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label for="name" class="control-label">Kéo dài thời gian nghỉ hưu đến ngày</label>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label for="name" class="control-label">Chức vụ đảm nhiệm</label>
                                    <select name="retirement_position_define_id" id="retirement_position_define_id" class="form-control input-sm input-required">
                                        {!! $optionChucVu !!}
                                    </select>
                                </div>
                            </div>
